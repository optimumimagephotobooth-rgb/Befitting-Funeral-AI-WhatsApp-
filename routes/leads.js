...
router.post('/generate', adminAuth, asyncHandler(async (req, res) => {
...
// Get lead by ID
router.get('/:id', adminAuth, asyncHandler(async (req, res) => {
...
router.post('/send-emails', adminAuth, asyncHandler(async (req, res) => {
...
router.post('/send-emails/new', adminAuth, asyncHandler(async (req, res) => {
...
// Get lead statistics
router.get('/stats/overview', adminAuth, asyncHandler(async (req, res) => {
